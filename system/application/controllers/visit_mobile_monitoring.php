...
class Visit_mobile_monitoring extends Controller {

	function Visit_mobile_monitoring()
	{
		parent::Controller();
		...
		$this->load->model('_visit_mobile_monitoring', 'visit');
	...
	function index()
	{
		$data['data'] = $this->visit->getHasil();
		$this->load->view('monitoring_mobile_visit/visit_view', $data);
	}
	...
	function detail()
	{
		...
		$this->load->view('monitoring_mobile_visit/visit_detail',$data);
	}
