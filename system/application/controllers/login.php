...
class Login extends Controller {
	...
	function index()
	{
		...
		$data = array();
		$data['data']          = $this->getdatalogin->getHeader();
		$data['datacount']     = $this->getdatalogin->getCountHeader();
		$data['databanner']    = $this->getdatalogin->getBanner();
		$data['databuilder']   = $this->getdatalogin->getBni();
		$data['datawizard']    = $this->getdatalogin->getHelpdesk();
		$data['databarbarian'] = $this->getdatalogin->getCrcode();
