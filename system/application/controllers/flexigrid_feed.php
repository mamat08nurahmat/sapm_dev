...
class Countries_Feed extends Controller {

	function Countries_Feed()
	{
		parent::Controller();
    ...
    function index()
    {
        ...
        $records = $this->flexigrid_model->get_countries();
    ...
    function deletec()
    {
        ...
        foreach ($countries_ids_post_array as $index => $country_id)
            if (is_numeric($country_id) && $country_id > 1)
                $this->flexigrid_model->delete_country($country_id);
    ...
    function export()
    {
        ...
        $records = $this->flexigrid_model->get_all_countries();
