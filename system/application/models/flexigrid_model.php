...
class Flexigrid_model extends Model 
{
	public $CI;
	public $table_name = 'NEWS';
	
	public function Flexigrid_model()
	{
	...
	public function get_select_countries()
	{
		...
		//$query = $this->db->query("select concat(judul, concat(':', id)) as name from $table_name where id is not null");
		//Get contents
