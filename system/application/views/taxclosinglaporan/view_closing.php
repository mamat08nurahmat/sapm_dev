        ...
        <div class="row" >
            ...
            <div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#008080; color:#fff;"><STRONG>REPORT DATA CLOSING</STRONG>

					</div><br />
					<div class="form-horizontal" style="margin:10px">

							<div class="form-group">
								<label class="col-lg-2">Jenis Closing</label>
								<div class="col-lg-3">
									<select class="form-control" id="id_aktivitas" required>
										<option selected>- Pilih Jenis Closing -</option>
                                        <?php foreach ($lookupclosing as $row) { ?>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#tampilkan").click(function(){
			var id_aktivitas=$("#id_aktivitas").val();
            ...
            $.ajax({
                url:"<?php echo site_url('aktivitas/cari_laporan');?>",
                type:"POST",
                data:"id_aktivitas="+id_aktivitas+"&tanggal2="+tanggal2+"&tanggal3="+tanggal3,
                cache:false,
