    ...
    <!-- Main content -->
   	<section class="content2">
        ...
        <!-- informasi user -->
            ...
            <div class="callout2" style="margin-bottom: 0!important;">
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    <form action="http://brftst.bni.co.id/new_sam/index.php/self_flagging/proses" method="post" enctype="multipart/form-data" class="form-inline">
                    <div class="form-group">
                    <label>Silahkan upload data usulan flagging dengan file excel 97-2003 extensi .xls</label>
                    </div>
                    <br><br>
                    ...
                    <div class="form-group">
                       <input name="userfile" id="userfile" accept="application/vnd.ms-excel" width="30" type="file">  
                    </div>  

                    <div class="form-group">
                    <input name="mysubmit" value="Upload" type="submit">&nbsp;<a href="http://brftst.bni.co.id/new_sam/public/file/xls/format_upload_flagging.xls">Download Format</a>
                    </div>

                    </form><br> 


                    <form action="" method="post" enctype="application/x-www-form-urlencoded" name="frmReport" id="frmReport" class="form-inline">
                        <div class="form-group">
                            <label for="npp">NPP</label>
                            <input name="ID" id="ID" size="10" class="input" type="text">&nbsp;
