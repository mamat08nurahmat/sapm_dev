        ...
        <div class="row" >
            ...
            <div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#008080; color:#fff;"><strong>EDIT USERTAX</strong></div><br />
					<div class="table-responsive" style="margin:10px; overflow:visible">
						 <form class="form-horizontal" role="form" method="post"  action="<?php echo site_url('usertax/proses_edit_usertax'); ?>">
							<div class="form-group">
							  <label class="control-label col-sm-2" for=""><p class="text-left">NPP</p></label>
							  <div class="col-sm-3">
								<input type="text" name="npp" maxlength="7" class="form-control" value="<?php echo $usertax->ID; ?>" readonly>
							  </div>
							</div>
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-5">
								<input type="text" name="nama_user"  class="form-control" value="<?php echo $usertax->USERNAME; ?>">
							  </div>
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-5">
								<input type="text" name="email"  class="form-control" value="<?php echo $usertax->EMAIL; ?>">
							  </div>
