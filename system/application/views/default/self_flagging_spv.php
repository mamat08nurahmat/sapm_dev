    ...
    <!-- Main content -->
   	<section class="content2">
        <!-- START CUSTOM TABS -->
        <h2 class="page-header">Self flagging</h2>
          ...
          <div class="col-xs-12">
            ...
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">SPV</a></li>
...
?>					
						...
						<tr bgcolor="#A5D3FA">
							...
							<th class="kecil" align="center">SALES TYPE</th>
							<th class="kecil" align="center">CR</th>
							<th class="kecil" align="center">BB</th>
							<th class="kecil" align="center">TOTAL</th>
							<th class="kecil" align="center">AUM CR</th>
							<th class="kecil" align="center">AUM BB</th>
							<th class="kecil" align="center">TOTAL AUM</th>
							<th class="kecil" align="center">Detail</th>
							<th class="kecil" align="center">KETERANGAN</th>
							<th class="kecil" align="center">PROSES</th>
						</tr>
						</thead>
<?php
...
?>
						...
						<tr bgcolor="#ffffff">
							...
							<td class="kecil" width="" align="center">32180</td> 
							<td class="kecil" width="" align="center">AGUS</td> 
							<td class="kecil" width="" align="center">PBA STA</td> 
							<td class="kecil" width="" align="center">457</td> 
							<td class="kecil" width="" align="center">0</td> 
							<td class="kecil" width="" align="center">457</td> 
							<td class="kecil" width="" align="center">297,114,830,842</td> 
							<td class="kecil" width="" align="center">0</td> 
							<td class="kecil" width="" align="center">297,114,830,842</td> 
							<td class="kecil" width="" align="center"><button  class="btn btn-block btn-default btn-sm"  >Info</button></td> 
							<td class="kecil" width="" align="center">NASKEL AUM,JUMLAH CIF CR OK dan JUMLAH CIF BB KURANG</td> 
							<td class="kecil" width="" align="center">DI SUPERVISOR</td> 							 
						</tr>
<!----
--->						
