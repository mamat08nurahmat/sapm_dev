        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    serverSide: true,
					//============
                    ajax: {"url": "self_flagging/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
//                        },{"data": "npp"},{"data": "sales_type"},{"data": "nama"},{"data": "status"},{"data": "upliner"},{"data": "keterangan"},{"data": "alamat"},{"data": "officeID"},{"data": "phone"},
						...
						{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},{"data": "JUDUL"},
                        {
                            "data" : "action",
                            "orderable": false,
