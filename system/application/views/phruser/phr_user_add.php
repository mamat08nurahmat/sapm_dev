    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#8FC0D8; color:#fff;"><strong>TAMBAH USER</strong></div><br />
                <div class="table-responsive" style="margin:10px; overflow:visible">
                     <form class="form-horizontal" method="post" role="form" id="frmlogin" action="<?php echo site_url('phr_user/save_user_action'); ?>">
                        <div class="form-group">
                          <label class="control-label col-sm-2" for=""><p class="text-left">NPP</p></label>
                          <div class="col-sm-3">
                            <input type="text" name="npp" id="npp" maxlength="7" class="form-control" required>
                          </div>
                        </div>
